		...
		jQuery(function($) {
    		...
    		var $table = $("#_table").table({
				...
				columns : [
			        ...
			        {field:'realname', title:'真名', mobileHide : true},
			        {field:'departName', title:'科室', mobileHide : true},
			        {field:'roomName', title:'诊室', mobileHide : true},
			        {field:'telephone', title:'电话', mobileHide : true},
