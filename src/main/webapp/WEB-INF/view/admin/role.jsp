...
<link rel="stylesheet" href="${_path}/custom/zTree/css/metroStyle/metroStyle.css?v=1" />
<link rel="stylesheet" href="${_path}/custom/zTree/css/metroStyle/metroStyle.custom.css" />
...
<script type="text/javascript">
	scripts.push(
			"${_path}/custom/zTree/js/jquery.ztree.core-3.5.min.js",
			"${_path}/custom/zTree/js/jquery.ztree.excheck-3.5.min.js");
